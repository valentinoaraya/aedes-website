export const ButtonWithEmoji = ({ children, emoji, className, distance }: {
    ...
    return (
        <div className="flex items-center justify-center space-x-2">
            <button className={`h-11 px-8 rounded-md relative overflow-hidden bg-black text-white flex items-center justify-center group/modal-btn bg-gradient-to-r from-red-500 to-rose-600 ${className}`}>
